...
[![Build Status](https://travis-ci.org/emilianobovetti/fpc.svg?branch=master)](https://travis-ci.org/emilianobovetti/fpc) [![dist/fpc.min.js file size](https://badge-size.herokuapp.com/emilianobovetti/fpc/master/dist/fpc.min.js)](https://github.com/emilianobovetti/fpc/blob/master/dist/fpc.min.js) [![devDependencies Status](https://david-dm.org/emilianobovetti/fpc/dev-status.svg)](https://david-dm.org/emilianobovetti/fpc?type=dev) [![TypeScript](https://img.shields.io/badge/TypeScript-.d.ts-blue.svg)](https://github.com/emilianobovetti/fpc/blob/master/src/fpc.d.ts) [![GPLv3 license](https://img.shields.io/badge/License-GPL--3.0-blue.svg)](https://github.com/emilianobovetti/fpc/blob/master/LICENSE) [![semantic-release](https://img.shields.io/badge/%20%20%F0%9F%93%A6%F0%9F%9A%80-semantic--release-e10079.svg)](https://github.com/semantic-release/semantic-release) [![Greenkeeper badge](https://badges.greenkeeper.io/emilianobovetti/fpc.svg)](https://greenkeeper.io/)
...
I made this implementation that supports piping and function composition with fluent syntax. This allows to apply more than one argument to non-curried functions.

Particular attention on portability: the very same code should work natively on [IE6](https://github.com/emilianobovetti/fpc-ie6-test-env) and with [TypeScript](https://github.com/emilianobovetti/fpc/blob/master/src/fpc.d.ts).
